...
namespace Utilities
{
    public class CAccount
    {
        ...
        public static void atmAccess()
        {
            ...
            try
			{
				AccountActions.validation(user, pin);
			}
			catch (Exception e)
			{
				Console.WriteLine(e);
            ...
            {
                case 1:
                    AccountActions.deposit(user, cardNum, pin);
                    break;
                case 2:
                    try
                    {
                        AccountActions.withdraw(user, cardNum, pin);
                    }
                    catch (Exception e)
                    {
                        Console.WriteLine(e);
                    ...
                    break;
                case 3:
                    AccountActions.showBalance(user, cardNum, pin);
                    break;
                case 4:
                    return;
            }
